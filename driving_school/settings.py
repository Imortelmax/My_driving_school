...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-9-q*=0*n%4bmf3yo&6+qe*-6yvintlhc7yn&!p+p7d(k#yzruc')
...
CSRF_TRUSTED_ORIGINS = [
    f"https://{h}" for h in os.environ.get('ALLOWED_HOSTS', 'localhost').split(',')
